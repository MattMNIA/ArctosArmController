          ...
          <div className="bg-red-900/20 border border-red-800 rounded-2xl p-4 mb-6">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-3 py-2 bg-red-600 hover:bg-red-700 disabled:bg-red-400 text-white rounded-lg font-semibold transition-colors duration-200 disabled:cursor-not-allowed text-sm"
              >
                <RefreshCw className="w-4 h-4" />
                <span>{reconnecting ? 'Reconnecting...' : 'Retry'}</span>
              </button>
            </div>
          </div>
        )}
            ...
            {connected && status && status.q ? (
              ...
              <div className="grid grid-cols-6 gap-4">
                {Array.from({ length: 6 }).map((_, idx) => (
                  <div
                    key={idx}
                    className="relative bg-gray-800/50 rounded-3xl border-2 border-dashed border-gray-600 p-6 opacity-50 h-64"
                  >
                    ...
                    <div className="bg-gray-700 rounded-2xl p-3 mb-4">
                      <div className="flex items-center justify-between">
                        <div>
                        ...
                        <div className="w-10 h-10 bg-gray-600 rounded-xl" />
                      </div>
                    </div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="bg-gray-700 rounded-xl p-2">
                          <div className="flex items-center space-x-2">
                            <div className="w-4 h-4 rounded-full bg-gray-600" />
                            <div>
                              <p className="text-xs font-semibold text-gray-500">Top</p>
                        ...
                        <div className="bg-gray-700 rounded-xl p-2">
                          <div className="flex items-center space-x-2">
                            <div className="w-4 h-4 rounded-full bg-gray-600" />
                            <div>
                              <p className="text-xs font-semibold text-gray-500">Bottom</p>
                              <p className="text-xs font-medium text-gray-500">--</p>
                            </div>
                          </div>
                        </div>
